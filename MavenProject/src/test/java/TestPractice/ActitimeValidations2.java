...
public class ActitimeValidations2 extends SeleniumUtil {
	@Test
	public void testActitime_Login() {
		...
		//System.out.println("is Home page displayed? "+actualHomePageTitle.equals(expectedHomePageTitle));
